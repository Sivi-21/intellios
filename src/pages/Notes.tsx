  ...
  return (
    <div className="space-y-6 select-none relative">
      ...
      {filteredNotes.length === 0 ? (
        <div className="p-16 text-center border border-zinc-900 bg-zinc-950/20 rounded-2xl flex flex-col items-center justify-center gap-2">

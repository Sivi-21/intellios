...
- Timestamp: ${(/* @__PURE__ */ new Date()).toLocaleString()}`, "Synthesized");
        setInputVal("");
  ...
  return <AnimatePresence>
      {commandBarOpen && <div className="fixed inset-0 z-50 flex items-start justify-center pt-[12vh] px-4">
  ...
  />
    ...
    /* List Results */
            ...
            <div className="flex-1 overflow-y-auto p-2">
              {filteredCommands.length === 0 ? <div className="p-8 text-center text-zinc-500 flex flex-col items-center justify-center gap-2">
    ...
    return <div key={cat} className="space-y-1">
      ...
      return <button
        ...
        className={`w-full flex items-center justify-between text-left p-2.5 rounded-lg border text-sm transition-all duration-100 ${isSelected ? "bg-zinc-900/90 text-white border-zinc-700/50 shadow-md" : "text-zinc-400 border-transparent hover:text-zinc-200"}`}
      >
                              ...
                              {isSelected && <span className="text-[10px] font-mono font-semibold text-zinc-500 flex items-center gap-1 bg-zinc-950 px-1.5 py-0.5 rounded border border-zinc-800">
                                  <span>ENTER</span>

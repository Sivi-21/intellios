import { EngineTheme } from '../context/AppContext';
...
export interface ThemePreset {
  ...
  glowHeading: string;
  textAccent: string;
  textMutedAccent: string;
  borderAccent: string;
  borderMutedAccent: string;
  bgAccent: string;
  bgMutedAccent: string;
  badgeAccent: string;
  textGradient: string;
  
  // High fidelity RGB codes for Canvas visualizations
  rawRGB: string; // e.g. "6, 182, 212"
}

export const THEME_PRESETS: Record<EngineTheme, ThemePreset> = {
  cyan: {
    id: 'cyan',
    name: 'CHRONOS BLUE',
    badge: 'COLD_ICE',
...
export function getThemeColors(theme: EngineTheme): ThemePreset {
